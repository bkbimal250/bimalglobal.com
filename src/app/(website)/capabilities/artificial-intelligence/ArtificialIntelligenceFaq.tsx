...
import type { FaqItem } from "@/content/artificial-intelligence";

export function ArtificialIntelligenceFaq({ items }: { items: readonly FaqItem[] }) {
  const baseId = useId();
  ...
  return (
    <div className="divide-y divide-[#171817]/15 border-y border-[#171817]/15">
      {items.map((item, index) => {
        ...
        const panelId = `${baseId}-ai-faq-${index}`;
        ...
        return (
          <article key={item.question}>
            ...
            >
              ...
              <span aria-hidden="true" className="shrink-0 font-sans text-2xl">
                {open ? "-" : "+"}
              </span>
            </button>
            <div
